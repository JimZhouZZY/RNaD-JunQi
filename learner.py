...
def optax_optimizer(
    ...
    class OptaxOptimizer:
        ...
        def __call__(self, params: Params, grads: Params) -> Params:
            updates, self.state = update_fn(grads,
                                            self.state)  # pytype: disable=annotation-type-mismatch  # numpy-scalars
...
class RNaDLearner(policy_lib.Policy):
  ...
  """
    ...
    def actor_step(self, env_step: EnvStep):
        ...
        actor_step = ActorStep(policy=pi, action_oh=action_oh,
                               rewards=())  # pytype: disable=wrong-arg-types  # numpy-scalars
